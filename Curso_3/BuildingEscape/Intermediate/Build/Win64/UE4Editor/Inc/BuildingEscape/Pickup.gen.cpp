...
// End Cross Module References
...
#endif
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_bUseMessagePickup_MetaData[];
#endif
		static void NewProp_bUseMessagePickup_SetBit(void* Obj);
		static const UE4CodeGen_Private::FBoolPropertyParams NewProp_bUseMessagePickup;
#if WITH_METADATA
...
#endif
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_APickup_Statics::NewProp_bUseMessagePickup_MetaData[] = {
		{ "Category", "Pickup" },
		{ "ModuleRelativePath", "Public/Pickup.h" },
	};
#endif
	void Z_Construct_UClass_APickup_Statics::NewProp_bUseMessagePickup_SetBit(void* Obj)
	{
		((APickup*)Obj)->bUseMessagePickup = 1;
	}
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_APickup_Statics::NewProp_bUseMessagePickup = { "bUseMessagePickup", nullptr, (EPropertyFlags)0x0010000000000001, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(APickup), &Z_Construct_UClass_APickup_Statics::NewProp_bUseMessagePickup_SetBit, METADATA_PARAMS(Z_Construct_UClass_APickup_Statics::NewProp_bUseMessagePickup_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_APickup_Statics::NewProp_bUseMessagePickup_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_APickup_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_APickup_Statics::NewProp_bUseMessagePickup,
	...
	IMPLEMENT_CLASS(APickup, 1856591657);
