...
#include "SaveSystem/SaveLoadBuildingCharacterData.h"
...
bool USaveLoadBuildingCharacterData::ShouldCreateSubsystem(UObject* Outer) const
{
	const UWorld* World = Cast<UWorld>(Outer);
	return World && World->IsGameWorld();
}

void USaveLoadBuildingCharacterData::Save(AActor* Actor)
{
	Super::Save(Actor);
...
void USaveLoadBuildingCharacterData::Load(AActor* Actor)
{
	Super::Load(Actor);
